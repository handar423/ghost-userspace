...
make(
    ...
    postfix_script = "cp $EXT_BUILD_ROOT/external/linux-new/tools/lib/bpf/libbpf.a $INSTALLDIR/lib/libbpf.a; " +
    ...
    "cp $EXT_BUILD_ROOT/external/linux-new/tools/lib/bpf/*.h $INSTALLDIR/include/libbpf",
...
make(
    ...
    # copy is necessary.
    postfix_script = "cp $EXT_BUILD_ROOT/external/linux-new/tools/bpf/bpftool/bpftool $INSTALLDIR/bin/bpftool",
    visibility = ["//visibility:public"],
)
